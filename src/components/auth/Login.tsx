...
export default function Login() {
  ...
  return (
    <div className="">
      <Header />
      <div className="pl-5 min-h-[60px] text-white bg-[#dc1431] flex items-center justify-start"><p>Log In to Online Banking</p></div>
        ...
        <div className="bg-white mx-auto rounded-xl max-w-[350px] py-7">
          <form onSubmit={handleLogin}>
            <div className="flex flex-col gap-6 border p-5 rounded-lg">
              ...
              <button
                type="submit"
                className="p-4 bg-[#0077BE] w-full text-white font-semibold rounded-md"
              >
                Sign In
              </button>
            </div>
